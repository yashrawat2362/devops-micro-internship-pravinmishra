...
![ss-5.1](./screenshots/ss6.5.1.png)

---

#### Screenshot 2 — Subnets list showing four subnets and their Availability Zones

![ss-5.2](./screenshots/ss6.5.2.png)

---

#### Screenshot 3 — Public route table showing the Internet Gateway route and both public-subnet associations

![ss-5.3](./screenshots/ss6.5.3.png)

---

#### Screenshot 4 — Private route table showing the NAT Gateway route and both private-subnet associations

![ss-5.4](./screenshots/ss6.5.4.png)

---

#### Screenshot 5 — NAT Gateway status showing Available and the Elastic IP

![ss-5.5](./screenshots/ss6.5.5.png)
...
![ss-5.6](./screenshots/ss6.5.6.png)

---

#### Screenshot 7 — EC2 Security Group inbound rules showing the ALB Security Group reference and SSH from your IP

![ss-5.7](./screenshots/ss6.5.7.png)

---

#### Screenshot 8 — RDS Security Group inbound rule showing the database port allowed only from the EC2 Security Group

![ss-5.8](./screenshots/ss6.5.8.png)
...
![ss-5.9](./screenshots/ss6.5.9.png)

---

#### Screenshot 10 — RDS connectivity section showing the DB Subnet Group and Security Group

![ss-5.10](./screenshots/ss6.5.10.png)
...
![ss-5.11](./screenshots/ss6.5.11.png)

---

#### Screenshot 12 — A running instance created from the template showing that the application responds on port 80 through a local test or browser using its public IP

![ss-5.12](./screenshots/ss6.5.12.png)
...
![ss-5.13](./screenshots/ss6.5.13.png)

---

#### Screenshot 14 — Target group showing at least one healthy target

![ss-5.14](./screenshots/ss6.5.14.png)
...
![ss-5.15](./screenshots/ss6.5.15.png)

---

#### Screenshot 16 — EC2 instances list showing two running instances in different Availability Zones

![ss-5.16](./screenshots/ss6.5.16.png)
...
![ss-5.17](./screenshots/ss6.5.17.png)

---

#### Screenshot 18 — Proof of a database write through a UI message or database query output

![ss-5.18](./screenshots/ss6.5.18.png)
...
![ss-5.19](./screenshots/ss6.5.19.png)

---

#### Screenshot 20 — Target group showing healthy targets after replacement

![ss-5.20](./screenshots/ss6.5.20.png)

---

#### Screenshot 21 — Evidence that an instance was removed, detached, placed in Standby, or stopped in one Availability Zone

![ss-5.21](./screenshots/ss6.5.21.png)

---

#### Screenshot 22 — Browser showing that the ALB DNS endpoint still works during the change

![ss-5.22](./screenshots/ss6.5.22.png)
