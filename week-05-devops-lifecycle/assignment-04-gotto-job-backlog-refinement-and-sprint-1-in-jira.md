...
*PO*: Responsible for deciding what has the most value and should be prioritized in the backlog — Prioritized UI improvements that would make Gotto Job clearer and more trustworthy for users.

*SM*: Responsible for ensuring the process is followed correctly — Kept the work organized through backlog refinement, sprint planning, estimation, and regular progress tracking.

*Dev Lead*: Responsible for what gets built — Built and verified a small UI improvement focused on better clarity and user experience.

*DevOps Lead*: Responsible for how it gets shipped — Committed the change, deployed it to the live environment, and verified the result through the public URL.
...
![ss-4](./screenshots/ss5.4.4.png)

---

#### Screenshot 5 — One Story opened showing its Story Points and acceptance criteria filled in

![ss-5](./screenshots/ss5.4.5.png)
...
![ss-7](./screenshots/ss5.4.7.png)

---

#### Screenshot 8 — One Story showing the Sub-tasks created

![ss-8](./screenshots/ss5.4.8.png)
...
![ss-10](./screenshots/ss5.4.10.png)

---

#### Screenshot 11 — Git commit output

![ss-11](./screenshots/ss5.4.11.png)

---

#### Screenshot 12 — Live URL in the browser showing the UI change, with the URL visible

![ss-12](./screenshots/ss5.4.12.png)
...
![ss-13](./screenshots/ss5.4.13.png)
...
![ss-14](./screenshots/ss5.4.14.png)
